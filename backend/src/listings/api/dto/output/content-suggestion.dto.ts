...
export class ContentSuggestionDto {
	...
	@ApiProperty({ 
		...
		example: 'Step into timeless style with this authentic Levi\'s Type III Trucker jacket. Features classic indigo wash, signature button front, and iconic chest pockets. Perfect layering piece for any season.'
	})
	description: string;
	...
	@ApiPropertyOptional({ 
		...
		example: 'Detected slight fading on left sleeve. Consider mentioning in description for transparency.'
	})
	insights?: string;
}